...
![](files/Bootup-Rejoin.png)

From the [sniffer](files/Bootup-Rejoin-Sniffer.isd), we can see that the sleepy end device scaned from channel 11 to channel 26, then rejoined after it found the network.

![](files/Bootup-Rejoin-Sniffer.png)
...
![](files/Optimized-Bootup-Rejoin.png)

Below is the [sniffer](files/Optimized-Bootup-Rejoin-Sniffer.isd):

![](files/Optimized-Bootup-Rejoin-Sniffer.png)

We can see that the device rejoins successfully for the first attempt. Therefore, it saves much time.

## 7. .sls Projects Used ##
ZigbeeMinimalSoc4164ASleep.sls
